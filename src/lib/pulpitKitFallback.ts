  ...
  outline: [
    {
      ...
      subtext: 'Israel grumbles for bread while God is already preparing manna in plain sight.',
    },
    {
      section: 'II. Bread That Cannot Be Stored',
      subtext: 'Daily dependence exposes our instinct to self-secure instead of trusting.',
    },
    {
      section: 'III. The True Bread From Heaven',
      subtext: 'Jesus reinterprets the manna as a sign pointing directly to Himself.',
    },
  ],
  talking_points: [
